    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some fo the resources that we used throughout this app. Note: You'll have one challenge where you will be asked to make this page better.</p>
            <ul>
                <li>The Official Docs</li>
                <li>React Router Dom</li>
                <li>Stephen Grider's Udemy Course for the Udemy API. He's all over of the place. </li>
            ...
            <h1>More Reading</h1>
            <p>We didn't really use these, but here are a few extra resoureces to help:</p>
            <ul>
                <li>Extra</li>
                <li>The Moviee App</li>
            </ul>
